                                         ...
                                         <tr style='border-collapse:collapse'> 
                                          <td class='es-m-p0r es-m-p20b' valign='top' align='center' style='padding:0;Margin:0;width:600px'> 
                                           <table width='100%' cellspacing='0' cellpadding='0' role='presentation' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px'> 
                                             <tr style='border-collapse:collapse'> 
                                              <td align='center' style='padding:0;Margin:0;padding-left:20px;padding-right:20px'><h1 style='Margin:0;line-height:60px;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-size:50px;font-style:normal;font-weight:bold;color:#293241'>Bem vindo à nossa família!</h1></td> 
                                             </tr> 
                                           </table></td> 
                                         </tr> 
                                       </table></td> 
                                       ...
                                       <table cellpadding='0' cellspacing='0' width='100%' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px'> 
                                         <tr style='border-collapse:collapse'> 
                                          <td align='center' valign='top' style='padding:0;Margin:0;width:600px'> 
                                           <table cellpadding='0' cellspacing='0' width='100%' role='presentation' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px'> 
                                             <tr style='border-collapse:collapse'> 
                                              <td align='left' style='padding:0;Margin:0;padding-left:20px;padding-right:20px'><p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#293241;font-size:16px'>Obrigado por se ter registado no nosso site, este email é enviado para a confirmação da sua nova conta, para que a mesma possa usufruir da nossa loja. Ao clicar no botão abaixo, você concorda com todos os nossos termos.</p></td> 
                                             </tr> 
                                           </table></td> 
                                         </tr> 
                                       </table></td> 
                                           ...
                                           <table cellpadding='0' cellspacing='0' width='100%' role='presentation' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px'> 
                                             ...
                                             <tr style='border-collapse:collapse'> 
                                              <td style='padding:0;Margin:0'> 
                                               <table cellpadding='0' cellspacing='0' width='100%' class='es-menu' role='presentation' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px'> 
                                                 <tr class='links-images-left' style='border-collapse:collapse'> 
                                                  <td align='left' valign='top' width='100%' style='Margin:0;padding-left:5px;padding-right:5px;padding-top:10px;padding-bottom:10px;border:0'><a target='_blank' href='' style='-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;color:#293241;font-size:14px'><img src='http://skyders.ml/images/30981615375244660.png' alt='Rua Dom João Pereira Venâncio 1, 2495-440 Fátima' title='Rua Dom João Pereira Venâncio 1, 2495-440 Fátima' align='absmiddle' width='20' style='display:inline-block !important;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;padding-right:15px;font-size:12px'>Rua Dom João Pereira Venâncio 1, 2495-440 Fátima</a></td> 
                                                 </tr> 
                                               </table></td> 
                                             </tr> 
                                             <tr style='border-collapse:collapse'> 
            ...
            if(!$userSearch){
                ...
                if($userSearch->num_rows > 0){
                    ...
                    if(testHash($password, $reg->password)){
                        if($reg->verified == 0){
                            $error = msg_erro("A sua conta ainda não foi verificada, veja no seu email! (Procure também no spam)");
                        ...
                        $error = msg_erro("A password está incorreta!");
                    }
                }else{
                    $error = msg_erro("Esse usuário não existe!");
                }
            }
        }
...
if(isset($_POST['registerForm'])){
        ...
        if(is_null($registerUser) || is_null($registerEmail) || is_null($registerPassword) || is_null($registerConfirmPassword)){
          ...
          if(trim($registerUser) == ""){
            $errorRegister = msg_erro("O nome não pode ficar vazio");
            $errorRegisterClass = 1;
          }else if(trim($registerEmail) == ""){
            $errorRegister = msg_erro("O email não pode ficar vazio");
            $errorRegisterClass = 1;
          }else if(trim($registerPassword == "")){
            $errorRegister = msg_erro("A password não pode ficar vazia");
            $errorRegisterClass = 1;
          }else{
            if($registerPassword != $registerConfirmPassword){
                $errorRegister = msg_erro("As passwords não são iguais!");
                $errorRegisterClass = 1;
            }else{
                ...
                if($usersSearch->num_rows > 0){
                    ...
                    if($regUsers->nome == $registerUser){
                        $errorRegister = msg_erro("Esse usuário já existe!");
                        $errorRegisterClass = 1;
                    }else if($regUsers->email == $registerEmail){
                        $errorRegister = msg_erro("Esse email já está registado!");
                        $errorRegisterClass = 1;
                    }
                }else{
                    ...
                    if ($db->query($queryRegister)) {
                        $errorRegister = msg_sucesso("Caso o seu email esteja correto, receberá um email de confirmação em breve!");
                        $errorRegisterClass = 1;
            ...
            <div class="signin-signup">
                ...
                <? echo $errorRegister ?>
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" placeholder="Usuário" name="registerUser">
                    </div>
                    <div class="input-field">
                        <i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
